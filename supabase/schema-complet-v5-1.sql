...
-- V5.1 : stabilisation Supabase
create index if not exists idx_projects_status on public.projects(status);
create index if not exists idx_chantier_photos_project on public.chantier_photos(project_id);
create index if not exists idx_chantier_documents_project on public.chantier_documents(project_id);
create index if not exists idx_chantier_notes_project on public.chantier_notes(project_id);
create index if not exists idx_project_materials_project on public.project_materials(project_id);
create index if not exists idx_project_vigilance_project on public.project_vigilance(project_id);
create index if not exists idx_employee_projects_project on public.employee_projects(project_id);
create index if not exists idx_employee_projects_employee on public.employee_projects(employee_id);
create index if not exists idx_employee_planning_project on public.employee_planning(project_id);
create index if not exists idx_employee_planning_employee on public.employee_planning(employee_id);
create index if not exists idx_employee_planning_dates on public.employee_planning(start_date, end_date);
create index if not exists idx_internal_requests_status on public.internal_requests(status);

create unique index if not exists idx_employee_projects_unique
on public.employee_projects(employee_id, project_id);
...
drop policy if exists "photos storage update" on storage.objects;
drop policy if exists "documents storage update" on storage.objects;

create policy "photos storage update" on storage.objects
