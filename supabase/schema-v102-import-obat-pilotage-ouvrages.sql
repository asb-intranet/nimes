-- ASB Intranet V102 — Import Excel OBAT dans Pilotage des ouvrages
-- Aucun changement de structure obligatoire si le script V100 a déjà été lancé.
-- Ce rappel garantit que la table nécessaire existe.
